...
export const StickyScroll = ({
    ...
    // Change target to 'document' so the whole page scrolls
    const { scrollYProgress } = useScroll({
        //@ts-ignore
        target: document, // This targets the whole page
    ...
    return (
        <motion.div
            ...
            className="h-auto flex justify-center relative space-x-10 rounded-md p-10"
            ref={ref}
        >
            ...
            <div
                ...
                className={cn(
                    "hidden lg:block h-screen w-80 rounded-md bg-white sticky top-10 overflow-hidden",
                    contentClassName
                )}
            >
