  ...
  return (
    <>
      <section className="py-24 relative">
        <div className="absolute h-[36.5rem] w-full top-0 bg-accent-foreground -z-10"></div>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="font-manrope text-5xl text-center font-bold text-gray-900  mb-4">
              Suitable pricing plans
            </h2>
            <p className="text-muted text-xl text-center leading-6">
            ...
            <div className="group relative flex flex-col mx-auto w-full max-w-sm bg-white rounded-2xl shadow-2xl transition-all duration-300  p-8 xl:p-12  ">
              <div className="border-b border-solid border-gray-200 pb-9 mb-9">
                <div className="w-16 h-16 rounded-full bg-indigo-50 mx-auto flex justify-center items-center transition-all duration-300 group-hover:bg-primary">
                  <svg
                    className="w-6 h-6 text-primary transition-all duration-300 group-hover:text-white"
                    viewBox="0 0 31 30"
                    fill="none"
                ...
                <h3 className="font-manrope text-2xl font-bold my-7 text-center text-primary">
                  Free Plan
                </h3>
              ...
              <ul className="mb-12 space-y-6 text-left text-lg text-gray-600 group-hover:text-gray-900">
                <li className="flex items-center space-x-3.5">
                  {/* <!-- Icon --> */}
                  <span className="w-1.5 h-1.5 rounded-full bg-primary text-muted"></span>
              ...
              <a
                href="javascript:;"
                className="py-2.5 px-5 bg-indigo-50 shadow-sm rounded-full transition-all duration-500 text-base text-primary font-semibold text-center w-fit mx-auto group-hover:bg-primary group-hover:text-white "
              >
                Purchase Plan
              </a>
              {/* <!--List End--> */}
